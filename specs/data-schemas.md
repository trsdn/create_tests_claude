...
```
create_tests/
├── tests/                           # Final test files (Markdown)
│   └── [country]/[region]/[school]/[subject]/[grade]/[topic]/
│       ├── test_name.md            # Student version
│       └── test_name_key.md        # Answer key
│
├── pdfs/                            # Generated PDF files
│   ├── student_versions/
│   │   └── [same hierarchy as tests/]
│   │       └── test_name.pdf
│   └── answer_keys/
│       └── [same hierarchy as tests/]
│           └── test_name_key.pdf
  ...
  "tests": [
    {
      ...
      "paths": {
        ...
        "pdf_student": "pdfs/student_versions/germany/bayern/gymnasium/mathematik/klasse_7/algebra/lineare_gleichungen.pdf",
        "pdf_key": "pdfs/answer_keys/germany/bayern/gymnasium/mathematik/klasse_7/algebra/lineare_gleichungen_key.pdf"
      },
